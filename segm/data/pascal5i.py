...
class Pascal5iDataset(Dataset):
    ...
    def build_img_metadata(self):
        ...
        def read_metadata(split, fold_id):
            fold_n_metadata = os.path.join('/home/prlab/wxl/dataset/dir/pcontext/VOCdevkit/VOC2012/Binary_map_aug/%s/split%d_%s.txt' % (split, fold_id,split))

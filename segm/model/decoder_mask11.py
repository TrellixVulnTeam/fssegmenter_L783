...
from segm.model.blocks_mask5 import Block, FeedForward
...
class MaskTransformer(nn.Module):
    ...
    def forward(self, x, fore_feature,im_size):
        ...
        for blk in self.blocks:
            ...
            # masks_0[:] = torch.tensor(-1e100).to(masks_0.device)
            ...
            x,masks_1 = blk(x,fore_feature,masks_0.reshape(masks_0.shape[0],1,1,masks_0.shape[1]))
            masks_0 = masks_1
